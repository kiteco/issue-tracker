...
![Notification at startup](images/welcome-message.png)
...
![Status panel showing "Kite is ready and working"](images/status-panel.png)
![Status panel showing that Kite is unavailable](images/status-panel-notStarted.png)
...
![Code completion of json.dumps()](images/code-completion-json.png)
...
![Code completion of json.dumps() with documentation](images/code-completion-json-quickdoc.png)
...
![Quick documentation popup](images/quick-doc.png)
...
![Popup after mouse move](images/mouse-over-popup.png)
...
![Param info of json.dumps()](images/param-info-kwargs.png)
...
![Whitelisting message for a file not yet whitelisted](images/file-not-whitelisted.png)  
...
![Kite plugin settings dialog](images/settings-dialog.png)
...
![Updating a shortcut used by the Kite plugin](images/settings-keyboard.png)
...
![Kite in the list of installed plugins](images/plugin-installation-check.png) 
...
![Kite status bar icon](images/status-panel.png) 
